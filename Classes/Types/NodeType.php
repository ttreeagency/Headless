    ...
    public function __construct(TypeResolver $typeResolver)
    {
        return parent::__construct([
            ...
            'fields' => [
                ...
                'isAggregate' => ['type' => Type::boolean(), 'description' => 'Whether or not this node type is an aggregate. The most prominent aggregate is a Document', 'resolve' => function (AccessibleObject $wrappedNodeType) { return $wrappedNodeType->getObject()->isAggregate(); }],
                'isOfType' => [
                    'type' => Type::boolean(),
                ...
                'fullConfiguration' => ['type' => $typeResolver->get(Scalars\UnstructuredObjectScalar::class), 'deprecationReason' => 'Not part of the public API', 'description' => 'Get the full configuration of the node type. Should only be used internally.'],
